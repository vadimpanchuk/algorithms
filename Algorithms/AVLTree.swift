public class AVLTreeNode<Key: Comparable, Payload> {
    public typealias Node = AVLTreeNode<Key, Payload>
...
extension AVLTreeNode {
    public func minimum() -> AVLTreeNode? {
    ...
    public func maximum() -> AVLTreeNode? {
...
extension AVLTreeNode: CustomDebugStringConvertible {
